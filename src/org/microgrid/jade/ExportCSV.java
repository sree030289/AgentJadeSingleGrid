...
public class ExportCSV {
    ...
    public void CreateFinalCSVFile(String filepath,int hourOfDay,String pcc_final,String [] MicroGrid1Details,String [] Batterydetails, int count)
    {
        try {
            FileWriter output;
            if(count==1){
           ...
           if(hourOfDay==0) {
               ...
               // Header column value
               String[] header = {"Hour of the Day", "MicroGrid1 Load", "MicroGrid1 Generation","Solar MicroGrid1 Generation","Wind MicroGrid1 Generation", "MicroGrid1 Credit", "MicroGrid1 Debit", "Battery SOC", "Battery Action"};
